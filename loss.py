...
class FocalLoss(nn.Module):
    ...
    def forward(self, logit, target):
        ...
        if logit.dim() > 2:
            ...
            # 这里最终实现的是，第一个参数是所有batch的图片的宽高总和，第二个参数是通道数
        ...
        # 将ground truth映射到one_hot_key中，其中[, 1]是异常所在的层
...
'''
SSIM 通过对比两个图像的相关性、灰度平均值、灰度标准差得出一个综合的评分。 SSIM越接近1说明图像重建得越好，如果等于1说明基本无失真重建。
'''
